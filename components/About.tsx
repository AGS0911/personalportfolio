const About = () => {
  return (
    <section className ="fullscreen background2 padding-container md:gap-20 lg: py-20">
    <div className = "flexCenter flex-0">
      ...
      <div className = "grid sm:grid-cols-1 md:grid-cols-2 mt-4">
        <div className = "space-y-4 animate-fadeInLeft"> 
          ...
          <p className = "text-bubble text-shadow regular-16 text-pink-800 text-center xl:max-w-[520px]">
             I was born and raised in the Greater Chicagoland Area. When I was younger, I originally wanted to be a lawyer until I discovered my love of math. Now, I want to integrate my love of statistics and STEM comunication into my career. In the future, I would like to pursue a PhD and spend time in industry while teaching on the side.
          </p>
